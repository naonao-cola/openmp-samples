/**
 * @author RookieHPC
 * @brief Original source code at https://rookiehpc.org/openmp/docs/section/index.html
 **/
...
/**
 * @brief Illustrates how to use a section clause.
